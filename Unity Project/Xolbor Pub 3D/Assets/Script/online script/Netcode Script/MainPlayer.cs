...
public class MainPlayer : NetworkBehaviour
{
    ...
    public TMP_Text namePrefabTextMeshPro;
    private TMP_Text nameLabel;
    public float nameLabelPositionY;

    private LoginManager loginManager;

    public bool canControlCharacterMovement = true;
    public bool isNewCharacterController;
    ...
    public override void OnNetworkSpawn()
    {
        ...
        nameLabel = Instantiate(namePrefabTextMeshPro, Vector3.zero, Quaternion.identity) as TMP_Text; //create name lable for player
    ...
    void SetPlayerName()
    {
        Vector3 nameLabelPos = Camera.main.WorldToScreenPoint(transform.position + new Vector3(0, nameLabelPositionY, 0));
    ...
    private void FixedUpdate()
    {
        ...
        {
            if (isNewCharacterController == false)
            {
    ...
    {
        return new Vector3(Random.Range(-3f, 3f), 0.1f, Random.Range(-3f, 3f));   //random the pos in x-z coordinate
    }
