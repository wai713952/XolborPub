...
public class MainPlayer : NetworkBehaviour
{
    ...
    public void Move()  //already explained that
    {
        ...
        {
            SubmitPositionRequestServerRpc();   //if you are the client, ask the server to move you to new position
        }
    }

    [ServerRpc] //requesting the server
    void SubmitPositionRequestServerRpc(ServerRpcParams rpcParams = default)    //ServerRpcParams is an optional attribute for runtime, nothing to bother really
    {
